...
class PeriodicTable {
  ...
  final Map <int, Element> byNumber = {};
  final Map <String, Element> byName = {}, bySymbol = {};

  PeriodicTable (this.elements) {
    for (Element element in elements) {
      byNumber [element.number] = element;
  ...
  operator [] (dynamic index) {
    if (index.runtimeType == int) return byNumber [index];
    else if (index.runtimeType == String) {
      if (index.length == 1 || index.length == 2) {
        return bySymbol [index];
      } else return byName [index];
    }
    else throw ArgumentError ("Invalid index: $index.");
  }
}
...
PeriodicTable periodicTable = PeriodicTable([
  ...
  Element(
    ...
    oxistates:'-1*',
    ionEnergy:[
      17.4228, 34.97, 62.707, 87.138, 114.24, 157.161, 185.182, 
      953.886, 1103.089, 
    ],
  ...
  Element(
    ...
    oxistates:'1*',
    ionEnergy:[
      5.1391, 47.286, 71.64, 98.91, 138.39, 172.15, 208.47, 
      264.18, 299.87, 1465.091, 1648.659, 
    ],
  ...
  Element(
      ...
      isotopes:{
        145: Isotope(144.912744, 1.0, 145)
      }
  ),
  Element(
      62, 'Sm', 'Samarium',
  ...
  Element(
      ...
      isotopes:{
        197: Isotope(196.966552, 1.0, 197)
      }
  ),
  Element(
      80, 'Hg', 'Mercury',
  ...
  Element(
      ...
      ionEnergy:[7.2855, 16.69, 25.56, 45.3, 56.0,
                 88.3, ],
      isotopes:{
        209: Isotope(208.980383, 1.0, 209)
      }
  ),
  Element(
      84, 'Po', 'Polonium',
      ...
      ionEnergy:[8.414, ],
      isotopes:{
        209: Isotope(208.982416, 1.0, 209)
      }
  ),
  Element(
      85, 'At', 'Astatine',
      ...
      ionEnergy:[],
      isotopes:{
        210: Isotope(209.987131, 1.0, 210)
      }
  ),
  Element(
      86, 'Rn', 'Radon',
      ...
      ionEnergy:[10.7485, ],
      isotopes:{
        222: Isotope(222.0175705, 1.0, 222)
      }
  ),
  Element(
      87, 'Fr', 'Francium',
      ...
      ionEnergy:[4.0727, ],
      isotopes:{
        223: Isotope(223.0197307, 1.0, 223)
      }
  ),
  Element(
      88, 'Ra', 'Radium',
      ...
      isotopes:{
        226: Isotope(226.0254026, 1.0, 226)
      }
  ),
  Element(
      89, 'Ac', 'Actinium',
      ...
      ionEnergy:[5.17, 12.1, ],
      isotopes:{
        227: Isotope(227.027747, 1.0, 227)
      }
  ),
  Element(
      90, 'Th', 'Thorium',
      ...
      isotopes:{
        232: Isotope(232.0380504, 1.0, 232)
      }
  ),
  Element(
      91, 'Pa', 'Protactinium',
      ...
      ionEnergy:[5.89, ],
      isotopes:{
        231: Isotope(231.0358789, 1.0, 231)
      }
  ),
  Element(
      92, 'U', 'Uranium',
  ...
  Element(
      ...
      ionEnergy:[6.2657, ],
      isotopes:{
        237: Isotope(237.0481673, 1.0, 237)
      }
  ),
  Element(
      94, 'Pu', 'Plutonium',
      ...
      ionEnergy:[6.026, ],
      isotopes:{
        244: Isotope(244.064198, 1.0, 244)
      }
  ),
  Element(
      95, 'Am', 'Americium',
      ...
      ionEnergy:[5.9738, ],
      isotopes:{
        243: Isotope(243.0613727, 1.0, 243)
      }
  ),
  Element(
      96, 'Cm', 'Curium',
      ...
      ionEnergy:[5.9914, ],
      isotopes:{
        247: Isotope(247.070347, 1.0, 247)
      }
  ),
  Element(
      97, 'Bk', 'Berkelium',
      ...
      ionEnergy:[6.1979, ],
      isotopes:{
        247: Isotope(247.070299, 1.0, 247)
      }
  ),
  Element(
      98, 'Cf', 'Californium',
  ...
  Element(
      ...
      ionEnergy:[6.5, ],
      isotopes:{
        257: Isotope(257.095099, 1.0, 257)
      }
  ),
  Element(
      101, 'Md', 'Mendelevium',
      ...
      ionEnergy:[6.58, ],
      isotopes:{
        258: Isotope(258.098425, 1.0, 258)
      }
  ),
  Element(
      102, 'No', 'Nobelium',
  ...
  Element(
      ...
      ionEnergy:[],
      isotopes:{
        268: Isotope(268.13882, 1.0, 268)})
]);

void main() {
  periodicTable['H'].description = (
